...
class DEC(object):
    ...
    def pretrain(self, x, y=None, optimizer='adam', epochs=200, batch_size=256, save_dir='DecKeras/results/temp'):
        print('...Pretraining...')
        print('hihi')
        ...
        weights_file = os.path.join(save_dir, 'autoencoder.weights.h5')
        ...
        # begin pretraining
        t0 = time()
        # Add callback for saving weights
        ...
        print('Pretrained weights are saved to', weights_file)
    ...
    def fit(self, x, y=None, maxiter=2e4, batch_size=256, tol=1e-3,
        ...
        for ite in range(int(maxiter)):
            if ite % update_interval == 0:
                ...
                if ite > 0:
                    model_file = os.path.join(save_dir, f'DEC_model_{ite}.weights.h5')
        ...
        # Save final model
        final_weights = os.path.join(save_dir, 'DEC_model_final.weights.h5')
